...
<table cellspacing="0" cellpadding="6" style="width:100%;border-collapse:collapse;margin:20px 0;">
    ...
    <tr>
        <th style="text-align:left;padding:10px;border:1px solid #e5e5e5;background:#f8f8f8;"><?php esc_html_e( 'Data conferma', 'eu-withdrawal-button' ); ?></th>
    ...
    <tr>
        ...
        <td style="padding:10px;border:1px solid #e5e5e5;"><?php esc_html_e( 'Confermato', 'eu-withdrawal-button' ); ?></td>
    </tr>
</table>
