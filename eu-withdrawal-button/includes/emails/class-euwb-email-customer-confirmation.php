...
class EUWB_Email_Customer_Confirmation extends WC_Email {
    ...
    public function __construct() {
        ...
        $this->description    = __( 'Inviata al cliente quando il recesso è confermato definitivamente (flusso standard e diretto).', 'eu-withdrawal-button' );
        $this->heading        = __( 'Il tuo recesso è stato confermato', 'eu-withdrawal-button' );
        $this->subject        = get_option( 'euwb_confirmation_email_subject', __( 'Conferma di recesso – Ordine #{order_number}', 'eu-withdrawal-button' ) );
    ...
    public function get_subject() {
        ...
        $raw        = get_option( 'euwb_confirmation_email_subject', parent::get_subject() );
        return EUWB_Emails::replace_placeholders( $raw, $order, $withdrawal );
    }

    public function get_content_html() {
        return wc_get_template_html(
            'euwb-customer-confirmation.php',
            array(
                'order'         => $this->object,
    ...
    public function get_content_plain() {
        return wc_get_template_html(
            'euwb-customer-confirmation-plain.php',
            array(
                'order' => $this->object,
                'email' => $this,
            ),
