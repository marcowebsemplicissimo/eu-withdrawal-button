...
<body style="font-family:Arial,sans-serif;color:#333;max-width:600px;margin:0 auto;padding:24px;">
  ...
  <table style="width:100%;border-collapse:collapse;margin:20px 0;">
    ...
    <tr>
      <td style="padding:10px;border:1px solid #ddd;"><strong><?php esc_html_e( 'Data recesso', 'eu-withdrawal-button' ); ?></strong></td>
      <td style="padding:10px;border:1px solid #ddd;"><?php echo esc_html( $date ); ?></td>
    </tr>
    <tr style="background:#f5f5f5;">
      <td style="padding:10px;border:1px solid #ddd;"><strong><?php esc_html_e( 'Stato', 'eu-withdrawal-button' ); ?></strong></td>
      <td style="padding:10px;border:1px solid #ddd;"><?php esc_html_e( 'Confermato', 'eu-withdrawal-button' ); ?></td>
    </tr>
  </table>
  <p><strong><?php esc_html_e( 'Cosa succede adesso?', 'eu-withdrawal-button' ); ?></strong></p>
  <ul>
    <li><?php printf( esc_html__( 'Il nostro team elaborerà la tua richiesta entro %d giorni lavorativi.', 'eu-withdrawal-button' ), absint( $refund_days ) ); ?></li>
    <li><?php esc_html_e( 'Il rimborso verrà emesso utilizzando lo stesso metodo di pagamento usato al momento dell\'acquisto, salvo diverso accordo.', 'eu-withdrawal-button' ); ?></li>
    <li><?php esc_html_e( 'Ti forniremo le istruzioni per la restituzione del prodotto (se applicabile).', 'eu-withdrawal-button' ); ?></li>
  </ul>
  <p style="font-size:12px;color:#999;margin-top:32px;">
    <?php esc_html_e( 'Questo messaggio è stato generato automaticamente ai sensi della Direttiva UE 2023/2673 e della Direttiva 2011/83/UE sui diritti dei consumatori.', 'eu-withdrawal-button' ); ?><br>
    <?php esc_html_e( 'Per ulteriori informazioni:', 'eu-withdrawal-button' ); ?> <?php echo esc_html( get_option( 'admin_email' ) ); ?>
